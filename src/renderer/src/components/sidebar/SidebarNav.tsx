...
import { BookOpen, CalendarClock, EyeOff, Files, Search, Smartphone, Workflow } from 'lucide-react'
  ...
  return (
    ...
    >
      ...
      >
        ...
        />
        <span className="flex-1">
          {translate('auto.components.sidebar.SidebarNav.harness', 'Orchestrator')}
        </span>
