...
type DispatchOptions = Pick<
  RpcContext,
  'signal' | 'authenticatedCallerFingerprint' | 'internalCaller'
>
...
export class RpcDispatcher {
  ...
  async dispatch(request: RpcRequest, options?: DispatchOptions): Promise<RpcResponse> {
    ...
    try {
      ...
      const invoke = (mutation?: DurableMutationInvocation) => {
        ...
        return method.handler(effectiveParams, {
          ...
          internalCaller: options?.internalCaller,
