 ...
 * installs seed it with the product worktree directory. Treating that seeded value as a choice
...
function getDefaultCreateProjectParent(store: Store): string {
  ...
  return join(home, productProfile.userDataDirectoryName, 'projects')
}
